    ...
    return (
        <Box>
            <Box marginY={4}>
                ...
                >
                    We are integrating your contract to web 2.0 providers
                </Typography>
                <Typography
                    variant="h6"
                    align={'center'}
                    ...
                    data-aos={'fade-up'}
                >
                    Our products and services are designed to help you integrate
                    your web 3.0 app.
                    <br />
                    We help you to integrate with web 2.0 providers including
                    mobile push notifications , email, on ramp and many others.
                </Typography>
            </Box>
