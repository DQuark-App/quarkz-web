    ...
    return (
        <Container>
            ...
            <p>
                ...
                intellectual property rights related to it, still belong to Alan
                MR.
            </p>{' '}
            <p>
                Alan MR is committed to ensuring that the app is as useful and
            ...
            <p>
                The DQuark app stores and processes personal data that you have
                ...
                mean that the DQuark app won’t work properly or at all.
            </p>{' '}
            <div>
                <p>
            ...
            <p>
                You should be aware that there are certain things that Alan MR
                ...
                provider, but Alan MR cannot take responsibility for the app not
            ...
            <p>
                Along the same lines, Alan MR cannot always take responsibility
                ...
                turn it on to avail the Service, Alan MR cannot accept
                responsibility.
            </p>{' '}
            <p>
                With respect to Alan MR’s responsibility for your use of the
                ...
                information to us so that we can make it available to you. Alan
                MR accepts no liability for any loss, direct or indirect, you
            ...
            <p>
                ...
                download the updates if you want to keep using the app. Alan MR
                does not promise that it will always update the app so that it
                is relevant to you and/or works with the Android version that
                you have installed on your device. However, you promise to
            ...
            <p>These terms and conditions are effective as of 2023-09-26</p>{' '}
            <p>
